...
FROM orders INNER JOIN customers USING(customer_id) INNER JOIN employees USING(employee_id)
...
SELECT company_name FROM customers EXCEPT SELECT company_name
